...
namespace IMG_Stego
{
    public partial class FormStego : Form
    {
        ...
        private void buttonApply1_Click(object sender, EventArgs e)
        {
            ...
            stopWatch.Start();
            Parallel.For(xtr, atr, new ParallelOptions { MaxDegreeOfParallelism = val2 }, x =>
            {
        ...
        {
            string app = "Stegenografia v1.0";
            string author = "Jakub Szczegielniak ";
            string year = " 2021 ";
            string email = "";
        ...
        private void FormStego_Load(object sender, EventArgs e)
        {
